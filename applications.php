<?php 
	...
	if(isset($_SESSION["email"]) && $_SESSION["isAdmin"] == 1)
	{
		...
		if(isset($_GET["validatedEmail"]))
		{
			...
			$sql = $connection->prepare("UPDATE Clients SET Approuve=1 WHERE email=:email");	
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="panel.php" class="nav-link">Dossiers en attente</a></li>
	          <?php } ?>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Accueil <i class="ion-ios-arrow-forward"></i></a></span> <span>Dépots de dossiers  <i class="ion-ios-arrow-forward"></i></span></p>
            <h1 class="mb-3 bread">Liste des dossiers en attente  </h1>
          </div>
        </div>
      </div>
    </section>
