...
<?php
	...
	if(isset($_GET["plate"]))
	{
		...
		$sql->execute();
		$vehicle = $sql->fetch(PDO::FETCH_ASSOC);
		$price = $vehicle["LoyerVehicule"];
		...
		$stripeProduct = $stripe->products->create(['name' => 'Location de véhicule',]);
		...
		['line_items' => [['price' => $stripePrice["id"]	
		,'quantity' => 1]]]
		);
	}	
...
?>
      ...
      <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/bg_3.jpg');" data-stellar-background-ratio="0.5">
      	<div class="overlay"></div>
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Accueil <i class="ion-ios-arrow-forward"></i></a></span> <span>Paiement <i class="ion-ios-arrow-forward"></i></span></p>
            <h1 class="mb-3 bread">Paiement de votre commande</h1>
          </div>
        </div>
      </div>
    </section>
   ...
   <?php if(isset($_SESSION['email']) && $_SESSION['isApproved'] == 1){ ?>
      <div class="container">
          <div class="col-md-8 block-9 mb-md-5">
            <form action="./charge.php" method="post" id="payment-form">
							<div class="form-row">
								<label for="card-element">Paiement par carte de crédit :</label>
									<div id="card-element">
										</div>
										<div id="card-errors">
		  				...
		  				<a href="<?php echo $stripeLink["url"]; ?>">Payer</a>
		  				<?php } else{ ?><p>Votre compte n'a pas encore été validé, vous n'êtes pas autorisé à effectuer ce paiement. Merci de retourner à <a href="index.php">l'accueil</a>.</p> <?php } ?>  
						</form>	
    			</div> 			
      </div>    
    </section>
